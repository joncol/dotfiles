...
syn match logEntryTime /\v\d{1,2}:\d{2}:\d{2}:\d{3} / nextgroup=logLevelInfo,logLevelDebug,logLevelWarning,logLevelError
...
syn match logLocation /\v\s+\w*/ contained nextgroup=logLocationSeparator
