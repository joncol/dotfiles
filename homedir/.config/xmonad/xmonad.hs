...
myKeys =
    ...
    , ("<XF86AudioLowerVolume>", spawn "~/.local/bin/lower-volume.sh")
    , ("M-<F2>", spawn "~/.local/bin/lower-volume.sh")
    , ("<XF86AudioRaiseVolume>", spawn "~/.local/bin/raise-volume.sh")
    , ("M-<F3>", spawn "~/.local/bin/raise-volume.sh")
