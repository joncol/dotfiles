...
#   3. Add Jira API permission with read:jira-work and write:jira-work scopes
...
AUTH_URL="https://auth.atlassian.com/authorize?audience=api.atlassian.com&client_id=${JIRA_OAUTH_CLIENT_ID}&scope=read%3Ajira-work%20write%3Ajira-work%20read%3Aconfluence-content.all%20read%3Aconfluence-space.summary%20search%3Aconfluence%20offline_access&redirect_uri=$(python3 -c "import urllib.parse; print(urllib.parse.quote('${CALLBACK_URL}', safe=''))")&response_type=code&prompt=consent"
